        ...
        <div className='starwWarsChar'>
            <div className='character' key={props.char.toString()}>
                <div className='details'>
                    ...
                    <p><strong>Home World:</strong> <img src='{props.char.homeworld}' /></p>
                    <p><strong>Height:</strong>{props.char.height} </p>
                    <p><strong>Gender:</strong>{props.char.gender}</p>
                    <p><strong>Species:</strong> <img src='{props.char.species}' /></p>
                    ...
                    <p><strong>Films:</strong> <img src='{props.char.films}' /></p>
                    <p><strong>Hair Color:</strong> <img src='{props.char.hair_color}' /></p>
                    ...
                    <p><strong>Vehicles:</strong> <img src='{props.char.vehicles}' /></p>
                </div>
            </div>
        </div>
    )
